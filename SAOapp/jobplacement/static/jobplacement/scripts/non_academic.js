$('document').ready(function(){
    $('#program_select').change(function(){
        var awards = {
            'AGRICULTURE': ['Leadership Award', 'Social Responsibility and Civic Engangement Award'],
            'BIT': ['Best OJT Award', 'Researcher of the Year'],
            'BES': ['Leadership Award'],
            'BSHM': ['Leadership Award'],
            'BSIE': ['Leadership Award', 'Outstanding Athlete Award', 'Researcher of the Year'],
            'BSIT': ['Best Capstone', 'Excellence Award', 'Leadership Award', 'Programmer of the Year'],
            'CAS': ['Academic Leadership Award', 'BAEL Pride Award', 'Leadership Award', 'Loyalty Award', 'Outstanding Athlete Award'],
            'FORESTRY': ['Leadership Award', 'Outstanding Athlete'],
            'COED': ['Best in Elocution Award', 'Leadership Award', 'Relentless Mentor of the Year Award', 'Researcher of the Year', 'Student Extensionista of the Year Award']
        };
