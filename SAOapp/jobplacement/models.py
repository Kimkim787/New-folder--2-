...
class OJTRequirements(models.Model):
    ...
    non_disclosure = models.FileField(blank=True)
    biodata = models.FileField(blank=True)
    parents_consent = models.FileField(blank=True)
    application_letter = models.FileField(blank=True)
    medical = models.FileField(blank=True)
    moa = models.FileField(blank=True)
    endorsement = models.FileField(blank=True)
